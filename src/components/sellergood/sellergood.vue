  ...
  <div class="goods-wrapper" v-show="showFlag">
    <div class="goods">
      <div class="menu-wrapper" v-el:menu-wrapper>
        <ul>
          <li v-for="item in seller.goods" class="menu-item" :class="{'current': currentIndex === $index}" @click="selectMenu($index, $event)">
      ...
      <div class="foods-wrapper" v-el:foods-wrapper>
        <ul>
          <li v-for="item in seller.goods" class="food-list food-list-hook">
...
<script type="text/ecmascript-6">
  ...
  import goodheader from '../header/header.vue';
  import { getCurrentSeller } from '../../vuex/actions';
  const ERR_OK = 0;
  ...
  export default {
    ...
    vuex: {
      getters: {
        seller: state => state.currentSeller
      },
      actions: {
        getCurrentSeller
      }
